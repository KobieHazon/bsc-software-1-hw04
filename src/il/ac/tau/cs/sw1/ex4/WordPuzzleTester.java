...
public class WordPuzzleTester {
    public static void main(String[] args) {
        ...
        char[] puzzle1 = {
                WordPuzzle.HIDDEN_CHAR, WordPuzzle.HIDDEN_CHAR, WordPuzzle.HIDDEN_CHAR,
                'e', WordPuzzle.HIDDEN_CHAR, WordPuzzle.HIDDEN_CHAR
        };
        char[] puzzle2 = {
                WordPuzzle.HIDDEN_CHAR, WordPuzzle.HIDDEN_CHAR, 'e', 'e', WordPuzzle.HIDDEN_CHAR
        };
        ...
        if (WordPuzzle.checkSolution(puzzle1, "wheeps", vocabulary)) {
            System.out.println("Error 5.1");
        }

        if (WordPuzzle.getSolution(puzzle2, new String[] {"tweet", "sleeping"}) != "tweet") {
